...
namespace QLBD
{
    public partial class FormDoiMatKhau : Form
    {
        ...
        private void buttonDoiMatKhau_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(*) FROM TaiKhoan WHERE Ten = @TenDN AND MatKhau = @MKCu";
            ...
            {
                // Đổi mật khẩu
                string update = "UPDATE TaiKhoan SET MatKhau = @MKMoi WHERE Ten = @TenDN";
