...
namespace QLBD
{
    public partial class FormKhoaHoc : Form
    {
        ...
        {
           /* DanhMucHang h = new DanhMucHang(textBoxMaHang.Text, textBoxTenHang.Text,
                textBoxDonViTinh.Text, Convert.ToDecimal(textBoxDonGia.Text));
            dm.Insert(h);
            Form_DanhMucHang_Load(sender, e);*/
